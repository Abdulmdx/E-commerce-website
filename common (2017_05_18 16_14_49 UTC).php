...
function dynamicSlides($nSlides) {
    for ($x = 1; $x <= $nSlides; $x++) {
        echo '<img class="mySlides" src="/images/slide/' . $x . '.jpg" style="width:100%;height:500px" alt="No image found">';
    };
}
...
function searchbar(){
	echo'<center>
	        ...
	        <input style="width:400px;height:20px;float:top" id="Search" type="text" name="keyword" placeholder="What are you looking for?">
